...
channel.queue_declare("queue_4")
channel.queue_declare("stream", durable=True, arguments={"x-queue-type": "stream"})
...
channel.queue_bind(queue="queue_3", exchange="direct")
channel.queue_bind(queue="queue_4", exchange="direct", routing_key="test-key")
channel.queue_bind(queue="queue_4", exchange="fanout")
channel.queue_bind(queue="stream", exchange="fanout")